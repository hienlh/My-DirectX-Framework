...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nShowCmd)
{
	...
	pResourceManager->AddTexture("EnermiesBosses", ".\\Resources\\Enemies and Boss\\enermies_and_bosses.png", NULL, ".\\Resources\\Enemies and Boss\\enermies_and_bosses.xml");
	...
	anim = new CAnimation("MegaManX WasHit", "MegaManX", 89, 3, 100, true);
	...
	do
	{
		...
		//CGameObject* pPlayer = new CGameObject("Player", Vector2(45, 875));
		 CGameObject* pPlayer = new CGameObject("Player", {2350,980});
		...
		{
			//Add Animation
			new CAnimation("GenjiBos", "EnermiesBosses", 33, 4, 100, true);
			...
			//Left Missle
			new CAnimation("GenjiBosMissle_down", "EnermiesBosses", 38, 2, 50);
			...
			pGenjiLight->AddComponent<CRenderer>()->SetSprite("EnermiesBosses",44);
			pGenjiLight->SetIsActive(false);
			pGenjiBos->AddComponent<GenjiBosController>()->m_light = pGenjiLight;

			//Shurikein
			new CAnimation("Shurikein_Init", "EnermiesBosses", 116, 72, 60, false);
			new CAnimation("Shurikein_Spinning", "EnermiesBosses", 180, 7 , 250, true);
			new CAnimation("Shurikein_WasHit", "EnermiesBosses", 186, 19, 100, true);
