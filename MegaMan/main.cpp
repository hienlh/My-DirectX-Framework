...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nShowCmd)
{
	...
	new CAnimation(L"MegaManX Init", L"MegaManX", 0, 2, 1000, false);
	new CAnimation(L"MegaManX InitLand", L"MegaManX", 2, 6, 100, false);
	...
	new CAnimation(L"MegaManX Jump", L"MegaManX", 34, 3, 100, false);
	new CAnimation(L"MegaManX Jump Shoot", L"MegaManX", 41, 3, 100, false);
	...
	anim = new CAnimation(L"MegaManX ClimbLadder", L"MegaManX", 62, 4, 100, true);
	anim->Add(L"MegaManX", 64)->Add(L"MegaManX", 63);
	...
	new CAnimation(L"MegaManX Power", L"MegaManX-Power", 0, 17, 30, true);
	...
	do
	{
		...
		pPlayer->AddComponent<CAnimator>()
			...
			->AddAnimation(L"MegaManX InitLand")
			...
			->AddTransition(L"MegaManX Init", L"MegaManX InitLand", true, L"isLandfall", true)
			->AddTransition(L"MegaManX InitLand", L"MegaManX Idle")
		...
		pLeftBlock->GetComponent<CTransform>()->Set_Scale(Vector2(2, 1));
		pLeftBlock->AddComponent<CRenderer>()->SetSprite(L"Block")->SetZOrder(0);
		pLeftBlock->AddComponent<CRigidbody>()->SetIsKinematic(true);
		pLeftBlock->AddComponent<CBoxCollider>()->SetIsDebugging(true);
		pLeftBlock->GetComponent<CBoxCollider>()->SetAutoBoundSize(true);

		pLeftBlock = new CGameObject(L"Ground1", Vector2(400, 350));
		pLeftBlock->AddComponent<CRenderer>()->SetSprite(L"Block")->SetZOrder(0);
		pLeftBlock->AddComponent<CRigidbody>()->SetIsKinematic(true);

		pLeftBlock = new CGameObject(L"Ground2", Vector2(550, 400));
		pLeftBlock->AddComponent<CRenderer>()->SetSprite(L"Block")->SetZOrder(0);
		pLeftBlock->AddComponent<CRigidbody>()->SetIsKinematic(true);
		pLeftBlock->AddComponent<CBoxCollider>()->SetIsDebugging(true);
		pLeftBlock->GetComponent<CBoxCollider>()->SetAutoBoundSize(true);
