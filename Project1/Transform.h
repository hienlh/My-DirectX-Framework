...
namespace Framework
{
	namespace Component
	{
		class CTransform final : public Object::CComponent
		{
			// Properties
		private:
			Vector3 m_position = VECTOR3_ZERO;
			Vector3 m_localPosition = VECTOR3_ZERO;
		...
		public:
			...
			// Internal methods
		private:
			bool Init(Vector3 position = VECTOR3_ZERO, Vector3 rotation = VECTOR3_ZERO, Vector3 scale = VECTOR3_ONE);
			void Release();
